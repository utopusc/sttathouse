...
const IndexSingle5 = () => {
  ...
  return (
    ...
    >
      ...
      <section className="features-section-two pt-115" id="onepage-features">
        <div className="container">
      ...
      <section className="project-section pt-75 pb-130" id="onepage-project">
        <div className="container">
          <div className="row justify-content-center">
      ...
      {/*====== Start Team Section ======*/}
      <section
        className="team-section bg-color-three pt-125 pb-110"
        id="onepage-team"
      >
        <div className="container">
          <div className="row justify-content-center">
      ...
      <section
        className="testimonial-section pt-125 pb-130"
      ...
      <section
        className="contact-section-three dark-blue-bg p-r z-1 pt-80"
        id="onepage-contact"
      >
        <div
